...
Friend::Friend(int friend_number, QByteArray pubkey, QString name, Link connection) :
    friend_number(friend_number), publickey(pubkey), name(name), connection(connection)
{
