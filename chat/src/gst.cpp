...
void sender(int fd) {
    ...
    if(!src) { std::cerr << "audiotestsrc could not be created.\n"; }
    ref<Gst::Element> sink = Gst::ElementFactory::create_element("fdsink");
    if(!sink) { std::cerr << "fdsink could not be created.\n"; }
...
void receiver(int fd) {
    ...
    if(!src) { std::cerr << "shmsrc could not be created.\n"; }
    ref<Gst::Element> sink = Gst::ElementFactory::create_element("pulsesink");
    if(!sink) { std::cerr << "pulsesink could not be created.\n"; }
